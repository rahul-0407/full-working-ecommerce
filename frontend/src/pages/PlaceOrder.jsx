  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      switch(method){
        ...
        case 'razorpay':
          const resposeRazorpay = await axios.post(backendUrl + '/api/v1/order/razorpay', orderData, {headers: {token}})
          if(resposeRazorpay.data.success){
            initPay(resposeRazorpay.data.order)
          }
          break;
